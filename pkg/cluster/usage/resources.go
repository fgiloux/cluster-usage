...
// FGI TODO: To be amended for non quota based calculation
// To me it seems that you may have multiple quotas per namespace
// and all the quotas need to be taken in consideration. This would not be my case.
// I don't think that I need to aggregate over multiple evaluators so that I may not need CalculateUsage at all
// I may directly go to evaluator.UsageStats or whatever I may have called the method
